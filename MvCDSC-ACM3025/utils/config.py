...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='acm', help='Input dataset')
    ...
    parser.add_argument('--n-epochs', default=500, type=int, help='Number of epochs')
    ...
    parser.add_argument('--hidden_dims3', type=list, nargs='+', default=[128], help='Number of the common dimensions')
    parser.add_argument('--embedding', type=int, default=512, help='The dimension of hidden layer')
    parser.add_argument('--lambda_1', default=5, type=float, help='Edge reconstruction loss function')
    ...
    parser.add_argument('--lambda_4', default=0.1, type=float, help='Cpq loss function')
    parser.add_argument('--lambda_5', default=10, type=float, help='Consistent loss function')
