...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='imdb', help='Input dataset')
    ...
    parser.add_argument('--n-epochs', default=200, type=int, help='Number of epochs')
    ...
    parser.add_argument('--hidden_dims3', type=list, nargs='+', default=[256, 128], help='Number of the common dimensions')
    ...
    parser.add_argument('--lambda_4', default=0.004, type=float, help='Cpq loss function')
    parser.add_argument('--lambda_5', default=0.001, type=float, help='Consistent loss function')
